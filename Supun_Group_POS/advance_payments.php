...
<?php if(!isset($_GET['embedded'])): ?><div class="top"><strong><i class="fa-solid fa-wallet"></i> Customer Advances</strong><div><a href="pos.php"><i class="fa-solid fa-arrow-left"></i> Back to POS</a><?php if(in_array($_SESSION['role']??'', ['admin','accountant'],true)): ?> &nbsp; <a href="dashboard.php"><i class="fa-solid fa-gauge-high"></i> Dashboard</a><?php endif; ?></div></div><?php endif; ?>
<main class="wrap"><div class="head"><div><h1>Customer Credit &amp; Installments</h1><div class="hint">Flexible account credit and order-specific installments are tracked separately.</div></div></div>
