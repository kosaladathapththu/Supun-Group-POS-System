...
<div class="top"><strong><i class="fa-solid fa-wallet"></i> Customer Advances</strong><div><a href="pos.php"><i class="fa-solid fa-arrow-left"></i> Back to POS</a><?php if(in_array($_SESSION['role']??'', ['admin','manager'],true)): ?> &nbsp; <a href="admin/sales.php">Admin</a><?php endif; ?></div></div>
