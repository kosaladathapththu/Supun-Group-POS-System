...
<nav class="sidebar">
    ...
    <div class="sb-nav">
        ...
        <a class="nav-item <?php echo in_array($current, ["dashboard.php"])
            ? "active"
            : ""; ?>" href="<?php echo $root_prefix; ?>dashboard.php">
            <i class="fa-solid fa-gauge-high"></i> Dashboard
        </a>

        <div class="nav-group-label">Reports</div>
        <a class="nav-item <?php echo in_array($current, [
            "sales.php",
            "daily_product_sales.php",
            "view_sale.php",
        ])
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>sales.php">
            <i class="fa-solid fa-file-invoice-dollar"></i> Sales Report
        </a>
        <a class="nav-item <?php echo $current == "orders.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>orders.php">
            <i class="fa-solid fa-receipt"></i> All Orders
        </a>

        <a class="nav-item <?php echo $current == "expense_report.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>expense_report.php">
            <i class="fa-solid fa-chart-pie"></i> Expense Report
        </a>

        <div class="nav-group-label">Finance</div>
        <a class="nav-item <?php echo $current == "expenses.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>expenses.php">
            <i class="fa-solid fa-money-bill-trend-up"></i> Expenses
        </a>
        <a class="nav-item <?php echo $current == "advances.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>advances.php">
            <i class="fa-solid fa-wallet"></i> Account Credit
        </a>
        <a class="nav-item <?php echo $current == "installments.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>installments.php">
            <i class="fa-solid fa-file-invoice-dollar"></i> Installments
        </a>
        <a class="nav-item <?php echo $current == "account_credit_report.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>account_credit_report.php">
            <i class="fa-solid fa-chart-column"></i> Account Credit Report
        </a>
        <a class="nav-item <?php echo $current == "installment_report.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>installment_report.php">
        ...
        <a class="nav-item <?php echo in_array($current, [
            ...
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>products.php">
            <i class="fa-solid fa-boxes-stacked"></i> Inventory
        </a>
        <a class="nav-item <?php echo $current == "product_import.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>product_import.php">
            <i class="fa-solid fa-file-arrow-up"></i> Import Inventory
        </a>
        <a class="nav-item <?php echo $current == "categories.php"
            ? "active"
            : ""; ?>" href="<?php echo $admin_prefix; ?>categories.php">
            <i class="fa-solid fa-tags"></i> Categories
        </a>
        <?php if (
            ($_SESSION["role"] ?? "") ===
            "admin"
        ): ?><a class="nav-item <?php echo $current == "users.php"
    ? "active"
    : ""; ?>" href="<?php echo $admin_prefix; ?>users.php">
            <i class="fa-solid fa-users"></i> Staff / Users
        </a><?php endif; ?>
    </div>
    <div class="sb-footer">
        <div class="sb-user">
            <div class="sb-avatar"><?php echo strtoupper(
            ...
            <div class="sb-user-info">
                ...
                <div class="role"><?php echo ($_SESSION["role"] ?? "") ===
                "accountant"
                    ? "Accountant"
                    : "Owner / Admin"; ?></div>
            </div>
