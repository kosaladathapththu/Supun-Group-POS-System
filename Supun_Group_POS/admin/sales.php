...
$where = [
    ...
    $conn->real_escape_string($filter_from) .
    "' AND '" .
    $conn->real_escape_string($filter_to) .
    "'",
];
if ($filter_pm !== "") {
    $where[] =
...
$total_rows = $conn
    ->query("SELECT COUNT(*) AS c FROM orders o WHERE $ws")
    ->fetch_assoc()["c"];
...
<div class="content">
    ...
    <div class="page-header">
        ...
        <div style="display:flex;gap:8px;" class="no-print">
            <a class="btn-secondary" target="_blank" href="print_report.php?type=sales&amp;from=<?php echo urlencode(
                $filter_from,
            ); ?>&amp;to=<?php echo urlencode(
    $filter_to,
); ?>&amp;payment_method=<?php echo urlencode(
    $filter_pm,
); ?>&amp;order_type=<?php echo urlencode($filter_type); ?>">
...
<a href="daily_product_sales.php" class="btn-secondary no-print" style="margin-bottom:18px;">
            ...
            <form method="GET" class="filter-form">
                ...
                <div class="ff">
                    ...
                    <select name="payment_method">
                        ...
                        "Card"
                            ? "selected"
                            : ""; ?>>Card</option>
                        <option value="QR"            <?php echo $filter_pm ==
                        "QR"
                            ? "selected"
                            : ""; ?>>QR</option>
                        ...
                        <option value="Cheque" <?php echo $filter_pm == "Cheque"
                            ? "selected"
                            : ""; ?>>Cheque</option>
                    </select>
                </div>
                <div class="ff">
                    ...
                    <select name="order_type">
                        ...
                        <option value="retail" <?php echo $filter_type ==
                        "retail"
                            ? "selected"
                            : ""; ?>>Retail</option>
    ...
    <div class="kpi-grid">
        <div class="kpi-card" style="border-top-color:var(--primary);">
            ...
            <div class="kpi-val" style="color:var(--primary);">Rs. <?php echo number_format(
                $kpi["total_revenue"],
                0,
            ); ?></div>
        ...
        <div class="kpi-card" style="border-top-color:var(--indigo);">
            ...
            <div class="kpi-val" style="color:var(--indigo);"><?php echo number_format(
                $kpi["total_orders"],
            ); ?></div>
        ...
        <div class="kpi-card" style="border-top-color:var(--green);">
            ...
            <div class="kpi-val" style="color:var(--green);">Rs. <?php echo number_format(
                $kpi["avg_order"],
                0,
            ); ?></div>
        ...
        <div class="kpi-card" style="border-top-color:var(--amber);">
            ...
            <div class="kpi-val" style="color:var(--amber);">Rs. <?php echo number_format(
                $kpi["total_discount"],
                0,
            ); ?></div>
    ...
    <div class="three-col">
        ...
        <div class="card table-card-full">
            <div class="card-header">
                ...
                <span class="count-badge"><?php echo $daily
                    ? $daily->num_rows
                    : 0; ?> days</span>
            </div>
            <div class="tbl-wrap" style="max-height:380px;overflow-y:auto;">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="white-space:nowrap;"><strong><?php echo date(
                                "d M",
                                strtotime($d["sale_date"]),
                            ); ?></strong></td>
                            <td style="color:var(--text-muted);font-size:11px;"><?php echo date(
                                "D",
                                strtotime($d["sale_date"]),
                            ); ?></td>
                            <td><span class="badge b-indigo"><?php echo $d[
                                "orders"
                            ]; ?></span></td>
                ...
                <div>
                    <?php if ($pm_sum && $pm_sum->num_rows > 0):
                        while ($pm = $pm_sum->fetch_assoc()):
                            ...
                            $pi =
                                $pm_icons[$pm["payment_method"]] ??
                                "fa-money-bill";
                            $pct =
                                $kpi["total_revenue"] > 0
                                    ? round(
                                        ($pm["total"] / $kpi["total_revenue"]) *
                                            100,
                                    )
                                    : 0;
                            ?>
                    <div class="mini-row">
                        <div>
                            <span class="badge <?php echo $pc; ?>"><i class="fa-solid <?php echo $pi; ?>"></i> <?php echo htmlspecialchars(
    $pm["payment_method"],
); ?></span>
                        ...
                        <div style="text-align:right;">
                            <div style="font-size:13px;font-weight:900;color:var(--text);">Rs.<?php echo number_format(
                                $pm["total"],
                                0,
                            ); ?></div>
                            <div style="font-size:10px;color:var(--text-muted);"><?php echo $pm[
                                "cnt"
                            ]; ?> orders</div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="mini-row">
                        ...
                        <div style="text-align:right;">
                            ...
                            <div style="font-size:10px;color:var(--text-muted);"><?php echo $ot[
                                "cnt"
                            ]; ?> orders</div>
                        </div>
                    </div>
        ...
        <div class="card table-card-full">
            ...
            <div>
                ...
                $max_rev =
                    count($tp_rows) > 0
                        ? max(array_column($tp_rows, "revenue"))
                        : 1;
                ...
                <div style="display:flex;align-items:center;gap:10px;padding:9px 14px;border-bottom:1px solid var(--border);">
                    ...
                    <div style="flex:1;min-width:0;">
                        <div style="font-size:12px;font-weight:800;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            ...
                            <?php if (
                                $tp["is_custom"]
                            ): ?><span style="font-size:9px;background:var(--amber-lt);color:var(--amber);padding:0 4px;border-radius:3px;margin-left:3px;">Custom</span><?php endif; ?>
                        </div>
                        <div style="font-size:10px;color:var(--text-muted);margin-top:1px;"><?php echo $tp[
                            "qty"
                        ]; ?> sold &bull; Rs.<?php echo number_format(
     $tp["revenue"],
     0,
 ); ?></div>
    ...
    <section class="card table-card-full" style="margin-bottom:20px;">
        <div class="card-header">
            ...
            <span class="count-badge"><?php echo $product_profit
                ? $product_profit->num_rows
                : 0; ?> products</span>
        </div>
        <div class="card-body" style="padding-bottom:12px;">
            <div class="profit-kpis">
                <div class="profit-kpi"><span>Net Product Sales</span><strong>Rs. <?php echo number_format(
                    $profit_kpi["net_product_sales"],
                    2,
                ); ?></strong></div>
                <div class="profit-kpi"><span>Cost of Goods Sold</span><strong style="color:var(--amber);">Rs. <?php echo number_format(
                    $profit_kpi["cogs"],
                    2,
                ); ?></strong></div>
                <div class="profit-kpi"><span>Gross Product Profit</span><strong class="<?php echo $profit_kpi[
                    "gross_profit"
                ] >= 0
                    ? "profit-positive"
                    : "profit-negative"; ?>">Rs. <?php echo number_format(
    $profit_kpi["gross_profit"],
    2,
); ?></strong></div>
            </div>
        </div>
        ...
        <?php if ($product_profit && $product_profit->num_rows):
            while ($pp = $product_profit->fetch_assoc()):
                $margin =
                    (float) $pp["net_sales"] != 0
                        ? ((float) $pp["gross_profit"] /
                                (float) $pp["net_sales"]) *
                            100
                        : 0; ?>
            <tr>
    ...
    $pp["is_custom"]
): ?> <span class="na-pill">Custom · cost unknown</span><?php endif; ?></td>
    ...
    3,
                ...
                <td>Rs. <?php echo number_format(
                    $pp["gross_sales"],
                    2,
                ); ?></td><td style="color:var(--red);">- Rs. <?php echo number_format(
    $pp["allocated_discount"],
    2,
    ...
    2,
                ...
                <?php if (
                    $pp["is_custom"]
                ): ?><td>—</td><td>—</td><td><span class="na-pill">N/A</span></td><?php else: ?><td>Rs. <?php echo number_format(
    $pp["product_cost"],
    2,
); ?></td><td class="<?php echo $pp["gross_profit"] >= 0
    ? "profit-positive"
    : "profit-negative"; ?>"><strong>Rs. <?php echo number_format(
    $pp["gross_profit"],
    2,
); ?></strong></td><td><span class="margin-pill"><?php echo number_format(
    $margin,
    1,
); ?>%</span></td><?php endif; ?>
            </tr>
        <?php
            endwhile;
             ...
             ?><tr><td colspan="9" class="empty-row">No paid product sales found for this period.</td></tr><?php
        endif; ?>
        </tbody></table></div>
    </section>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:8px;">
                                <div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:900;color:#fff;flex-shrink:0;">
                                    <?php echo strtoupper(
                                        substr($cr["full_name"] ?? "U", 0, 1),
                                    ); ?>
                                </div>
                                <strong><?php echo htmlspecialchars(
                                    $cr["full_name"] ?? "Unknown",
                                ); ?></strong>
                            </div>
                        </td>
                        <td><span class="badge b-indigo"><?php echo $cr[
                            "orders"
                        ]; ?> orders</span></td>
                        <td><strong style="color:var(--primary);">Rs. <?php echo number_format(
                            $cr["revenue"],
    ...
    <div class="card table-card-full">
        <div class="card-header">
            <h3>
                ...
                <span style="font-size:11px;font-weight:700;color:var(--text-muted);margin-left:6px;"><?php echo number_format(
                    $total_rows,
                ); ?> records</span>
            </h3>
        </div>
        ...
        <div class="pagination no-print">
            <a href="?page=<?php echo max(1, $page_num - 1) .
                $qs; ?>" class="pag-btn <?php echo $page_num == 1
    ? "disabled"
    : ""; ?>">
            ...
            <a href="?page=<?php echo $p .
                $qs; ?>" class="pag-btn <?php echo $p == $page_num
    ? "active"
    : ""; ?>"><?php echo $p; ?></a>
            <?php endfor;
            ?>
            <a href="?page=<?php echo min($total_pages, $page_num + 1) .
                $qs; ?>" class="pag-btn <?php echo $page_num == $total_pages
    ? "disabled"
    : ""; ?>">
