...
</style></head><body><div class="actions"><a href="advance_payments.php">Back</a><button onclick="window.print()">Print Whole Statement</button></div><main class="sheet"><header class="head"><img class="logo" src="supun-logo.png" alt="Supun Group"><h1>Customer Account Credit Statement</h1><p>Complete history of money received and used for purchases</p></header>
