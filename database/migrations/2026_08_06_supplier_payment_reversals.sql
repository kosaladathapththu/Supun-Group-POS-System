ALTER TABLE supplier_payments
  ...
  ADD COLUMN IF NOT EXISTS reversal_type ENUM('cheque_returned','payment_reversed','other') NULL AFTER status,
  ADD COLUMN IF NOT EXISTS reversal_reason VARCHAR(255) NULL AFTER reversal_type,
  ...
  ADD INDEX IF NOT EXISTS idx_supplier_payment_status (status);
